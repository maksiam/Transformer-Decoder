...
class AttentionHead(nn.Module):
    ...
    def __init__(self, head_size: int, num_embed: int, block_size: int, dropout: float):
        """
        Args:
            head_size (int): embedding dimension // number of heads
            num_embed (int): embedding dimension
